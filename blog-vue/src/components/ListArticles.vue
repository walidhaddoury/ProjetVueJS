...
<div>
    <div class="title">
        ...
        <div class="tableau" v-for = "(item, index) in articlesCut" :key="index">
          <h1> {{item.Titre}} </h1>
          <p>{{troncText(item.Content)}}</p>
          <div class="info">
            <p class="date">{{item.Date}}</p>
          <p class="auteur">{{item.Auteur}}</p>
          <p class="btn"><button>Lire</button> </p>
          </div>
